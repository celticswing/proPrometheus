...
namespace ImGui
{
	...
	IMGUI_API bool          IsClippedEx2(const ImRect& bb, const ImGuiID* id, bool clip_even_when_logged);
	IMGUI_API bool          IsHovered(const ImRect& bb, ImGuiID id, bool flatten_childs = false);
	IMGUI_API bool   ItemAdd2(const ImRect & bb, const ImGuiID * id);
	...
	IMGUI_API bool          ButtonEx1(const char * label, const ImVec2 & size_arg, ImGuiButtonFlags flags);
	IMGUI_API bool          ButtonEx2(const char * label, const ImVec2 & size_arg, ImGuiButtonFlags flags);
	IMGUI_API bool          ButtonEx2(const char * label, const ImVec2 & size_arg, ImGuiButtonFlags flags);
	IMGUI_API bool          ButtonEx3(const char * label, const ImVec2 & size_arg, ImGuiButtonFlags flags);
	IMGUI_API bool          ButtonEx4(const char * label, const ImVec2 & size_arg, ImGuiButtonFlags flags);
	IMGUI_API bool          ButtonEx5(const char * label, const ImVec2 & size_arg, ImGuiButtonFlags flags);
	IMGUI_API bool          ButtonEx6(const char * label, const ImVec2 & size_arg, ImGuiButtonFlags flags);
	IMGUI_API bool          ButtonEx7(const char * label, const ImVec2 & size_arg, ImGuiButtonFlags flags);
