...
namespace ImGui
{
	...
	IMGUI_API bool          Button1(const char* label, const ImVec2& size = ImVec2(0, 0));
	IMGUI_API bool          Button2(const char* label, const ImVec2& size = ImVec2(0, 0));
	IMGUI_API bool          Button3(const char* label, const ImVec2& size = ImVec2(0, 0));
	IMGUI_API bool          Button4(const char* label, const ImVec2& size = ImVec2(0, 0));
	IMGUI_API bool          Button5(const char* label, const ImVec2& size = ImVec2(0, 0));
	IMGUI_API bool          Button6(const char* label, const ImVec2& size = ImVec2(0, 0));
	IMGUI_API bool          Button7(const char* label, const ImVec2& size = ImVec2(0, 0));
