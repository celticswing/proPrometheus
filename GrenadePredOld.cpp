...
void grenade_prediction::Paint()
{
	...
	if ((type) && path.size()>1)
	{
		...
		Color boxColor(int(g_Options.Colors.GrenadeCollision[0] * 255), int(g_Options.Colors.GrenadeCollision[1] * 255), int(g_Options.Colors.GrenadeCollision[2] * 255), 200);
		Vector prev = path[0];
