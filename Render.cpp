...
void Render::SetupFonts()
{
	...
	g_Surface->SetFontGlyphSet(font.ESP, "Smallest Pixel-7", 11, 400, 0, 0, FONTFLAG_OUTLINE | FONTFLAG_DROPSHADOW);
...
//	g_Surface->SetFontGlyphSet(font.Icon, "Counter-Strike", 16, 500, 0, 0, FONTFLAG_OUTLINE | FONTFLAG_ANTIALIAS);
	g_Surface->SetFontGlyphSet(font.Guns, "Smallest Pixel-7", 12, 550, 0, 0, FONTFLAG_DROPSHADOW | FONTFLAG_OUTLINE);
