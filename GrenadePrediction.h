...
private:
	...
	Color TracerColor = Color(int(g_Options.Colors.color_grenadeprediction[0] * 255.f), int(g_Options.Colors.color_grenadeprediction[1] * 255.f), int(g_Options.Colors.color_grenadeprediction[2] * 255.f));
	Color boxColor = Color(int(g_Options.Colors.GrenadeCollision[0] * 255.f), int(g_Options.Colors.GrenadeCollision[1] * 255.f), int(g_Options.Colors.GrenadeCollision[2] * 255.f));
public:
